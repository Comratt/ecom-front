...
const Delivery = ({ className }) => {
    ...
    return (
        <div className={componentClasses}>
            ...
            <p>Безкоштовна адресна доставка кур&apos;єром при замовленні від 6000грн. (Ви нічим не ризикуєте, при умові, якщо вам костюм не підходе зворотня доставка за наш рахунок).</p>
