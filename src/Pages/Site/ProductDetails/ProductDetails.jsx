    ...
    return (
        <>
            ...
            <div className="lib-product_info">
                <div className="container">
                    <Title type={1}>
                        Вітаємо в інтернет-магазині жіночого одягу Bozhevilno - Вашому провіднику у світі моди та стилю! Відібрані тільки найстрімніші тренди та найбільший вибір жіночого одягу, який задовільнить найвибагливіші смаки! Успішні покупки починаються з Bozhevilno, мета якого - полегшити і зробити приємним Ваш досвід купівлі жіночого одягу онлайн.
                    </Title>
                    <Title type={2}>
                    ...
                    <Title type={3}>
                        Bozhevilno - магазин, що враховує дрібниці, що роблять Ваші покупки максимально комфортними. Ми пропонуєmo швидку та безкоштовну доставку для оселярів України. Крім того, Вам належить право на безкоштовне повернення товару протягом 14 днів!
                    </Title>
                    <Title type={4}>
                        З Bozhevilno Ви завжди будете в курсі актуальних акцій та обов'язково знайдете найкращі пропозиції серед новинок! Уважно стежте за асортиментом товарів, робіть вибір та насолоджуйтеся чудовою атмосферою Вашого улюбленого магазину. Дозвольте Bozhevilno зробити Ваші покупки незабутнім та ефективним досвідом і переконайтеся самі, що справжній успіх в пошуках неймовірного жіночого одягу лежить в Bozhevilno!
                    </Title>
                </div>
            </div>
        </>
