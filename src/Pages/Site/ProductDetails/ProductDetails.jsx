                                    ...
                                    <AccordionItem className="product-delivery" label="Доставка та оплата" index="1">
                                        <ReactMarkdown>
                                            {'#### Клієнт може оплатити своє замовлення будь-яким зручним для нього способом: \n'
                                                + '- Безкоштовна адресна доставка кур\'єром при замовленні від 6000грн. (Ви нічим не ризикуєте, при умові, якщо вам костюм не підходе зворотня доставка за наш рахунок). \n'
                                                + '- Готівкою чи картою безпосередньо в шоу-румі: \n'
                                                + 'м. Львів, вул. Івана Франка, 33 \n'
                                                + 'м. Чернівці, вул. Героїв Майдану 12 \n'
                                                + '- Безкоштовна доставка у відділення Нової Пошти \n'
                                                + '- Відправка відбувається протягом 3-5 робочих днів. \n'
