...
export const Home = () => {
    ...
    return (
        <View>
            ...
            <View className="main-container">
                <Title type={1}>
                    Вітаємо в інтернет-магазині жіночого одягу Bozhevilno!
                    У нас ви знайдете останні тренди моди та найширший асортимент стильних та якісних рішень для Вашого гардероба.
                    Ваші пошуки кінчаються тут, адже Bozhevilno - ідеальне місце, метою якого є створити максимально легкий, приємний та ефективний процескупівлі жіночого одягу в Україні.
                </Title>
                <Title type={2}>
                ...
                <Title type={3}>
                    Bozhevilno орієнтується на деталі, які робять нас відрізняють від інших магазинів жіночого одягу. Ми забезпечуємо швидку та безкоштовну доставку по всій Україні, а також можливість безплатного повернення товару протягом 14 календарних днів, для отримання максимально вигідних і комфортних умов покупки для наших клієнтів.
                </Title>
                <Title type={4}>
                    Слідкуйте за нашими акціями та новими надходженнями, обирайте напрямок для шопінгу в Bozhevilno і насолоджуйтеся зручністю, якісним асортиментом та приємною атмосферою вашого улюбленого інтернет-магазину жіночого одягу. Дозвольте Bozhevilno допомогти Вам зробити ваші покупки приємний та ефективний досвід, дізнайтесь, чому ми заслужили таку популярність серед модниць українського мегафункціонального інтернет-майста. Зробіть свій вибір та переконайтеся самі, що жоден інший інтернет-магазин не може пропонувати вам більше!
                </Title>
            </View>
        </View>
    );
