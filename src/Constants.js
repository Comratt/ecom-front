...
export const MARKET_NAME = 'Fenix voentorg';
export const MARKET_DESCRIPTION = `Інтернет-магазин ${MARKET_NAME}: військовий інтернет-магазин, що спеціалізується на тактичному спорядженні та мілітарі одязі ➤ Військова форма`;
export const MARKET_TITLE = `Інтернет-магазин ${MARKET_NAME}: - найкращий військовий інтернет-магазин в Україні`;
export const MARKET_KEYWORDS = `${MARKET_NAME.toLowerCase()}, ${MARKET_NAME.toUpperCase()}, воєнторг, військторг, військовий магазин, магазин для військових, військовий інтернет магазин, магазин для військових`;
