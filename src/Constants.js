...
export const MARKET_NAME = 'Besco';
export const MARKET_DESCRIPTION = `Інтернет-магазин ${MARKET_NAME}: купити Жіночий одяг саме в нас. Купуйте в ${MARKET_NAME}! | Офіційна гарантія | Доставка по всій Україні | Якісний Жіночий одяг та спортивні костюми $ Вигідні ціни та знижки %`;
export const MARKET_TITLE = `Інтернет-магазин ${MARKET_NAME}: сайт з найпопулярнішим Жіночим одягом та спортивними костюмами в Україні`;
export const MARKET_KEYWORDS = `${MARKET_NAME.toLowerCase()}, ${MARKET_NAME.toUpperCase()}, костюми, жіночі костюми, куртки, жіночі куртки, купити, костюм для спорту, спорт, лосіни, жіночі, дешевий спортивний жіночий одяг, онлайн-магазин`;
