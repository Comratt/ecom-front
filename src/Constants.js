...
export const MARKET_NAME = 'Lancaster';
export const MARKET_DESCRIPTION = `Інтернет-магазин ${MARKET_NAME}: купити чоловічу куртку саме в нас. Купуйте в ${MARKET_NAME}! | Офіційна гарантія | Доставка по всій Україні | Якісні чоловічі куртки, костюми $ Вигідні ціни та знижки %`;
...
export const MARKET_KEYWORDS = `${MARKET_NAME.toLowerCase()}, ${MARKET_NAME.toUpperCase()}, костюми, чоловічі костюми, куртки, чоловічі куртки, купити, онлайн-магазин`;
