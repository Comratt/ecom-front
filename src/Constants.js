...
export const MARKET_NAME = 'Pulse';
export const MARKET_DESCRIPTION = `Інтернет-магазин ${MARKET_NAME}: купити жіночий одяг саме в нас. Купуйте в ${MARKET_NAME}! | Офіційна гарантія | Доставка по всій Україні | Якісні жіночі сукні, костюми $ Вигідні ціни та знижки %`;
export const MARKET_TITLE = `Інтернет-магазин ${MARKET_NAME}: сайт з найпопулярнішим жіночим одягом в Україні`;
export const MARKET_KEYWORDS = `${MARKET_NAME.toLowerCase()}, ${MARKET_NAME.toUpperCase()}, костюми, жіночі костюми, куртки, жіночі куртки, купити, костюм на весілля, свадьба, костюм для спорту, костюм на пошив, онлайн-магазин`;
